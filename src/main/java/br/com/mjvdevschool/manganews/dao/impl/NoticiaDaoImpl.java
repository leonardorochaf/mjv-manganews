...
public class NoticiaDaoImpl implements NoticiaDao {
    ...
    public List<Noticia> buscarTodos() {
        String sql = "SELECT n.id, n.titulo, n.corpo, n.dataLancamento, n.visualizacoes, n.urlImagem, a.id, a.nome FROM noticia AS n JOIN autor AS a ON n.autor_id = a.id ORDER BY dataLancamento DESC";
    ...
    public List<Noticia> buscarMaisVistos(int limit) {
        String sql = "SELECT n.id, n.titulo, n.corpo, n.dataLancamento, n.visualizacoes, n.urlImagem, a.id, a.nome FROM noticia AS n JOIN autor AS a ON n.autor_id = a.id ORDER BY visualizacoes DESC LIMIT :limit";
