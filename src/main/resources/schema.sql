...
INSERT INTO manga(nome)
    VALUES ('testeNome'), ('testeNome2');

INSERT INTO autor(nome)
    VALUES ('Leonardo Rocha'), ('William Alechevez');

INSERT INTO noticia(titulo, corpo, dataLancamento, visualizacoes, urlImagem, manga_id, autor_id)
    VALUES
    ...
    1, 2),
    ('Mangá de One Piece sofrerá uma pausa devido à uma doença do autor',
    'A conta oficial do Twitter do departamento editorial da revista Weekly Shonen Jump revelou então que o mangá One Piece não aparecerá na 44ª edição da revista como havia sido planejado. O departamento editorial explicou que o mangá está dando uma pausa devido à uma “doença repentina” do autor Eiichiro Oda. A secretaria informou que a Oda está em recuperação e que o mangá voltará na 46ª edição da revista, que sairá portanto no dia 17 de outubro. One Piece também já sofreu atrasos devido ao COVID-19. Oda alertou em maio que mais atrasos são possíveis, pois sua equipe reorganizou o local de trabalho para facilitar o distanciamento social.',
    '2020-02-10',
    50,
    'https://animenew.com.br/wp-content/uploads/2020/10/Manga-de-One-Piece-sofrera-uma-pausa-devido-a-uma-doenca-do-autor-696x348.jpg',
    2, 1),
